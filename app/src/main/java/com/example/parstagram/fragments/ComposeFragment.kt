    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.btnSubmit).setOnClickListener {
            ...
            if (photoFile != null) {
                ...
                Toast.makeText(requireContext(), "Picture was taken!", Toast.LENGTH_SHORT).show()
                //goToLoginActivity()
            } else {
                Log.e(MainActivity.TAG, "No picture attached")
            }
        }
...
/*
    private fun goToLoginActivity() {
        val intent = Intent(requireContext().@MainActivity, MainActivity::class.java)
